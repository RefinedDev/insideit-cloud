                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            cursor.execute(f"SELECT roleid FROM reactionroles WHERE guildid = {str(ctx.guild.id)} AND emoji = '{emoji}' AND messageid = {denymsg2.content}")
                            res = cursor.fetchall()
                            if len(res) == 0:
                                ...
                                cursor.execute(f"DELETE FROM reactionroles guildid = {str(ctx.guild.id)} AND emoji = '{emoji}' AND messageid = {denymsg2.content}")
