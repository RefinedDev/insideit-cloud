                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            cursor.execute(f"SELECT roleid FROM reactionroles WHERE guildid = {str(ctx.guild.id)} AND channelid = {str(channel.id)} AND messageid = {(str(denymsg2.content))} AND emoji = '{emoji}'")
                            res = cursor.fetchall()
                            if len(res) == 0:
                                ...
                                cursor.execute(f"DELETE FROM reactionroles guildid = {str(ctx.guild.id)} AND channelid = {str(channel.id)} AND messageid = {(str(denymsg2.content))} AND emoji = '{emoji}'")
